...
sub register_implementation { 'XML::Rabbit::Trait::XPathObjectMap' }

1;

=head1 NAME

XML::Rabbit::Trait::XPathObjectMap - Moose-based XML loader - multiple XML DOM object xpath extractor trait
